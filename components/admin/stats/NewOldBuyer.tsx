...
import { compareNewOld } from "@/lib/orderActions";

function NewOldBuyer() {
      ...
      async function getData() {
        try {
          ...
          if (stats.start_date && stats.end_date) {
            const statsData = await compareNewOld({
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-xl font-semibold">Ponavljajoči in novi kupci</p>
          ...
          <ResponsiveContainer>
            <PieChart width={730} height={250}>
              <Pie
                ...
                endAngle={405}
                label={({ name }) =>
                  name === "repeat" ? "Ponavljajoči" : "Prvič"
                }
              >
